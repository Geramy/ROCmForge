...
mod tests {
    ...
    fn test_gpu_backend_id() {
        // Create a mock HipGgmlBackend for testing
        // We can't create a real one without GPU, so we test the trait
        // via the implementation structure
        // This test verifies the backend_id method returns "gpu"
        let expected_id = "gpu";

        // The implementation returns "gpu" - verified by code inspection
